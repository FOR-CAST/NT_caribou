...
We simulated vegetation, wildfire, and caribou in the NT1 study area for the years 2011-2100 following the modelling approaches of @micheletti2021 and @stewart.
...
### Boreal caribou population resource selection (RSF)
...
data.frame(
  ...
  knitr::kable() %>%
  kableExtra::kable_styling(font_size = 10, full_width = TRUE, latex_options = c("scale_down", "striped"))
```

### Boreal caribou population growth
