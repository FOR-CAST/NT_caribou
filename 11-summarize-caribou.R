...
caribouPopulationGrowthTable <- mergePredictedCaribouTables(pathToFiles = dirname(Paths$outputPath), ## TODO: unused argument
                                                            climateScenarios = climMods,
                                                            yr = YS,
                                                            runs = RUNS,
                                                            studyAreaName = studyAreaName,
                                                            herdSHP = SHP) ## TODO: unused argument

popGTB <- file.path(caribouPlotsDir, "populationGrowthTable.csv")
...
dTablePath <- file.path(Paths$outputPath, "disturbanceTable.csv")
